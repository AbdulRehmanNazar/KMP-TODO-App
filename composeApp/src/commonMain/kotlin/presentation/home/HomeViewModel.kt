...
typealias MutableTasks = MutableState<RequestStates<List<ToDoTask>>>
typealias Tasks = MutableState<RequestStates<List<ToDoTask>>>

class HomeViewModel(private val mongoDB: MongoDB) : ScreenModel {
    private var _activeTasks: MutableTasks = mutableStateOf(RequestStates.Idle)
    val activeTasks: Tasks = _activeTasks

    private var _completedTasks: MutableTasks = mutableStateOf(RequestStates.Idle)
    val completedTasks: Tasks = _completedTasks

    init {
        _activeTasks.value = RequestStates.Loading
        _completedTasks.value = RequestStates.Loading
